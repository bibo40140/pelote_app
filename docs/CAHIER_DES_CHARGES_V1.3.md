...
**Statut :** Référence fonctionnelle validée avant conception SQL  
...
**Fichier :** `docs/CAHIER_DES_CHARGES_V1.3.md`
...
**Fin du cahier des charges fonctionnel et technique PELOTE_APP, version 1.3.**
